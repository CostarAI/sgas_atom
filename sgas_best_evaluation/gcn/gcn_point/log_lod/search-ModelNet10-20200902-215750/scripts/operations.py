...
OPS = {
    ...
    # 原子操作�?1
    'Conv1': lambda C, stride, affine: Conv3(C, C, 'relu', 'batch', bias=False), 
    # # 原子操作�?2
    # 'Conv2': lambda C, stride, affine: Conv3(C, C, 'relu', 'batch', bias=False),
    # # 原子操作�?3
    # 'Conv3': lambda C, stride, affine: Conv3(C, C, 'relu', 'batch', bias=False),
    # # 原子操作�?4
    # 'Conv4': lambda C, stride, affine: Conv3(C, C, 'relu', 'batch', bias=False),
    # # 原子操作�?5
    # 'Conv5': lambda C, stride, affine: Conv3(C, C, 'relu', 'batch', bias=False),
}
